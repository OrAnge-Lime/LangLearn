...
public final class ActivitySignUpBinding implements ViewBinding {
  ...
  private ActivitySignUpBinding(@NonNull RelativeLayout rootView, @NonNull Button btnSignup,
      @NonNull EditText edtEmail, @NonNull EditText edtPass, @NonNull EditText edtUsername,
  ...
  public static ActivitySignUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignUpBinding((RelativeLayout) rootView, btnSignup, edtEmail, edtPass,
          edtUsername, langlearn, logo);
    }
